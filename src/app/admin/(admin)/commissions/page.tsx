    ...
    return (
      <div className="space-y-6">
        ...
        <div className="rounded-xl border border-red-500/20 bg-red-500/5 p-6">
          ...
          <button onClick={fetchCommissions} className="rounded-lg border border-white/10 px-4 py-2 text-sm font-medium text-gray-300 hover:text-white transition-colors">
            Retry
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {selected && (
          <div className="rounded-xl border border-white/5 bg-white/[0.02] p-6 space-y-4 h-fit lg:sticky lg:top-4">
            ...
            {selected.nsfw && <span className="inline-block text-xs bg-red-500/10 text-red-400 px-2 py-1 rounded-full">18+ NSFW Commission</span>}
            <div className="space-y-3">
              ...
              {selected.description && (
                <div>
                  ...
                  <p className="text-sm text-white whitespace-pre-wrap bg-white/5 rounded-lg p-3">{selected.description}</p>
                </div>
              )}
              {selected.additional && (
                <div>
                  <p className="text-xs font-medium text-gray-500 mb-1">Additional Info</p>
                  <p className="text-sm text-white whitespace-pre-wrap bg-white/5 rounded-lg p-3">{selected.additional}</p>
                </div>
              )}
            </div>
