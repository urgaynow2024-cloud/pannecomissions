        ...
        <form onSubmit={handleSubmit} className="rounded-xl border border-white/5 bg-white/[0.02] p-6 space-y-4">
          ...
          <div className="flex items-center gap-6">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" checked={formData.featured} onChange={(e) => setFormData({ ...formData, featured: e.target.checked })} className="rounded border-white/20 bg-white/5 text-purple-600 focus:ring-purple-500 focus:ring-offset-0" />
            ...
            >
              <div className="aspect-[4/3] bg-black relative overflow-hidden">
                ...
                <div className="absolute top-2 left-2 flex gap-2">
                  {item.featured && <span className="bg-purple-600 text-white text-[10px] font-medium px-2 py-0.5 rounded-full">Featured</span>}
