...
const navItems = [
  ...
  { href: "/admin/nsfw", label: "NSFW Portfolio", icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" },
  ...
  { href: "/admin/reviews", label: "Reviews", icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.77 9.77 0 01-3.8-.6L3 21l1.4-5.2A9.94 9.94 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" },
  { href: "/admin/commissions", label: "Commissions", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" },
  ...
  { href: "/admin/content", label: "Site Content", icon: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" },
  ...
  return (
    <>
      <button
        ...
        className="fixed top-4 left-4 z-50 md:hidden bg-purple-600 text-white p-2 rounded-lg border border-white/10"
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-40 w-64 bg-[#0f0f0f] border-r border-white/5 transform transition-transform duration-200 ease-in-out
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-white/5 space-y-2">
          ...
          <form action="/api/admin/auth/logout" method="POST">
            <button
              type="submit"
              className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-red-400 hover:text-red-300 hover:bg-red-500/5 transition-colors"
            >
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
