...
const navItems = [
  ...
  { href: "/admin/nsfw", label: "NSFW", icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" },
...
export default function AdminSidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-40 w-64 bg-brand-dark border-r border-white/5 transform transition-transform duration-200 ease-in-out
        ...
        <div className="p-6 border-b border-white/5">
          <Link href="/admin" className="block" onClick={() => setOpen(false)}>
            <h1 className="text-lg font-bold tracking-tight text-white font-display">
              PANNE
              <br />
              <span className="text-brand-purple-400">ADMIN</span>
            </h1>
          </Link>
        </div>
